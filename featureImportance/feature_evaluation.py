...
def evaluate_features( file_name ):
    feature_name = ['numProject-0', 'numReport-0', 'numBug-0', 'percBug-0',	'numProject-1', 'numReport-1',
                    'numBug-1', 'percBug-1', 'numProject-2', 'numReport-2', 'numBug-2', 'percBug-2', 'numProject-3', 
                    'numReport-3','numBug-3', 'percBug-3', 'durationLastAct', 'relevant',
...
evaluate_features_multiple_projects ( '../data/input/weka/save test set 20 with topic', '../data/output/featureImportance/featureImportance-testSet20.csv')
